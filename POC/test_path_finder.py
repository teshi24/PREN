...
test_set = [
    # config 1 values
    ({1: 'red', 2: 'blue', 3: 'red', 4: 'yellow', 5: '', 6: '', 7: 'yellow', 8: 'red'}, [4, 3, 1, 1, 1, 3, 4, 2, 3, 2, 4, 3, 3]),
    # expected startpos = 50, was 75
    # config 2 values
    ({1: 'yellow', 2: 'red', 3: '', 4: 'blue', 5: 'yellow', 6: 'red', 7: '', 8: 'blue'}, [3, 2, 4, 3, 4, 1, 4, 2, 4, 3, 4, 1, 1]),
    # expected startpos = 75, was 75
    ## now ok
    # config 3 values
    ({1: 'blue', 2: 'blue', 3: 'yellow', 4: 'red', 5: 'red', 6: 'red', 7: 'blue', 8: 'yellow'},  [4, 1, 1, 1, 4, 2, 4, 3, 1, 3, 4, 1, 4, 2, 1, 3, 1]),
